...
//  DataStructures
//
//  Created by Reich, Brandon on 4/17/18.
...
BinaryTreeNode<Type> * AVLTree<Type> :: removeNode(BinaryTreeNode<Type> * parent, Type inserted)
{
    ...
    else
    {
        ...
        else
        {
            ...
            parent -> setNodeData(leftMost -> getData());
...
template <class Type>
BinaryTreeNode<Type> * AVLTree<Type> :: insertNode(BinaryTree<Type> * parent, Type inserted)
{
    if (parent == nullptr)
    {
